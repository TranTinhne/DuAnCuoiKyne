...
<div class="row text-center">
    <div class="col-md-6">
        <div class="thumbnail">
            <img src="img/<?php echo $book['hinhanh']; ?>" alt="<?php echo htmlspecialchars($book['TenSanPham']); ?>">
        </div>
    </div>
    <div class="col-md-6">
        <h4 class="tensanpham">
        ...
        <p class="addtocart">
            <a href="ThemVaoGioHang.php?id=<?php echo $maGiay; ?>&url=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" class="btn btn-primary" role="button">
